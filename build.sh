...
download () {
    ...
    wget -N https://bitbucket.org/multicoreware/x265/downloads/x265_2.9.tar.gz -P "$DOWNLOAD_DIR"
    tar -xf "$DOWNLOAD_DIR"/x265_2.9.tar.gz -C "$BUILD_DIR"
    ...
    wget -N https://github.com/FFmpeg/FFmpeg/archive/19546cfef103bdc967b0e06ec35c96766e3febec.zip -O "$DOWNLOAD_DIR"/ffmpeg.zip
